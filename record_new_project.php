                    ...
                    <div>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-style1 mg-b-10">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Record New Partnership Project</li>
                            </ol>
                        </nav>
                        <h4 class="mg-b-0 tx-spacing--1">Record New Partnership Project</h4>
                    </div>
                    <div class="d-none d-md-block">
                       
                        <a href="view_all_cells.php" class="btn btn-sm pd-x-15 btn-warning btn-uppercase mg-l-5"><i data-feather="book" class="wd-10 mg-r-5"></i>View All Partnership Projects</a>
                                    ...
                                    <div class="col-lg-7 col-xl-8">
                                        ...
                                        <form action="" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" style="border-color:#7CB74B; border-width:1px; border-radius:10px" class="form-control" id="project_name" name="project_name" placeholder="Enter new Project Name in the System" required>
                                            </div>

                                            <div class="form-group">
                                                <label class="d-block">Project Description</label>
                                                <textarea class="form-control" style="border-color:#7CB74B; border-width:1px; border-radius:10px" required name="project_desc" placeholder="Enter Project Description" rows=5></textarea>
                                            </div>
                                            
                                            <div class="form-group">
                                                <label class="d-block">Project Target Amount ($)</label>
                                                <input step="any" type="number" style="border-color:#7CB74B; border-width:1px; border-radius:10px" class="form-control" id="project_target" name="project_target" placeholder="Enter Project Target Amount" required>
                                            </div>
                    
                                          
                                            <button type="submit" onclick="record_new_project_show_loader()" class="btn btn-primary" name="record_new_project">Record New Project</button>
