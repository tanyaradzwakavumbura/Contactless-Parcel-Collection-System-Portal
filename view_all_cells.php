                    ...
                    <div>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-style1 mg-b-10">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">View All Cells</li>
                            </ol>
                        </nav>
                        <h4 class="mg-b-0 tx-spacing--1">View All Cells</h4>
                    </div>
                    ...
                    <div data-label="Example" class="df-example demo-table col-md-12">
                        ...
                        <table id="example1" class="table table-hover table-bordered">
                            ...
                            <tbody>
                                ...
                                $find_data = $connect->prepare("SELECT * FROM cells");
                                $find_data->execute();
                                while($row=$find_data->fetch(PDO::FETCH_ASSOC)){
                                    $cell_id = $row["id"];
                                    $cell_code = $row["code"];
                                    $cell_name = $row["name"];
                                    $cell_address = $row["address"];
                                    $cell_date = $row["date"];
                               ...
                               ?>
                                <tr>
                                    ...
                                    <td><?php echo $cell_code;?></td>
                                    <td><?php echo $cell_name;?></td>
                                    <td><?php echo $cell_address;?></td>
                                    <td><?php echo $count_all_cell_members;?></td>
