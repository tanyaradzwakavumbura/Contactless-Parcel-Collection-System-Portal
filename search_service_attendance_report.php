                    ...
                    <div>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-style1 mg-b-10">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Search Service Attendance Report</li>
                            </ol>
                        </nav>
                        <h4 class="mg-b-0 tx-spacing--1">Search Service Attendance Report</h4>
                    </div>
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="row">
                                <div class="form-group col-12">
                                    <input type="date" name="service_date" id="service_date" class="form-control" style="border-color:#767F9B; border-width:1px; border-radius:10px" required>
                                </div>
                            ...
                            <br>
                            <center>
                                <button type="submit" class="btn btn-primary" name="generate_service_attendance_report">Generate Service Attendance Report</button>
                            </center>
