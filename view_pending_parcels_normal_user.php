            ...
            <div class="container ">
                <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
                    ...
                    <div class="d-none d-md-block">
                        <a href="view_all_in_transit_parcels_by_normal_user" class="btn btn-sm pd-x-15 btn-primary btn-uppercase"><i data-feather="book" class="wd-10 mg-r-5"></i>In-Transit Parcels</a>
                        ...
                        <table id="example1" class="table table-hover table-bordered">
                            ...
                            <tbody>
                               ...
                               if($role == "normal_user"){
                                    ...
                                    $statp = "Pending";
                                    $find_all_in_transit_parcels->execute([$statp,$user]);
