...
if(!isset($_SESSION["cashup_report"])){
    header("location:generate_day_end_report");
}else{

    $cashup_report = $_SESSION["cashup_report"];

    $find_cashier_details = $connect->prepare("SELECT * FROM users WHERE username=?");
    $find_cashier_details->execute([$cashup_report]);
...
$find_the_total_for_the_day_query->execute([$current_date, $cashup_report]);
                        ...
                        <div class="card">
                            ...
                            <div class="card-body pd-lg-25">
                                <div class="tx-center">
                                    ...
                                    <hr>
                                    <h3><b>Cashier Report for <?php echo $current_date." Generated at ".$current_time;?></b></h3>
                                </div>
                                <center>
                                            ...
                                            <table id="example1" class="table table-hover table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    while($row=$find_all_catregories->fetch(PDO::FETCH_ASSOC)){
                                                        ...
                                                        ");
                                                        $find_total_vehicles_per_category->execute([$cashup_report, $current_date, $category_code]);
                                    ...
                                    <div class="col-lg-7 col-xl-12">
                                        <div data-label="Example" class="df-example demo-table col-md-12">
                                            ...
                                            <table id="example1" class="table table-hover table-bordered">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $find_all_vehicle_entry = $connect->prepare("SELECT DISTINCT code, amount, vehicle, entrance_time, cashier FROM vehicle_entry WHERE date=? AND cashier=? ORDER BY entrance_time");
                                                    $find_all_vehicle_entry->execute([$current_date,$cashup_report]);
                                    ...
                                    <div class="col-lg-7 col-xl-12">
                                        <div data-label="Example" class="df-example demo-table col-md-12">
                                            ...
                                            <table id="example1" class="table table-hover table-bordered">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $find_all_vehicle_entry = $connect->prepare("SELECT DISTINCT code, amount, vehicle, entrance_time, cashier FROM vehicle_entry WHERE date=? AND cashier=? AND amount=?");
                                                    $stat_amount = 0;
                                                    $find_all_vehicle_entry->execute([$current_date,$cashup_report,$stat_amount]);
                                                    while($row=$find_all_vehicle_entry->fetch(PDO::FETCH_ASSOC)){
                                                        $ve_id = $row["id"];
                                                        $ve_transaction_code = $row["transaction_code"];
                                                        $ve_category = $row["category"];
                                        ...
                                        <div data-label="Example" class="df-example demo-table col-md-12">
                                            ...
                                            <table id="example1" class="table table-hover table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    $find_all_void_transactions_query = $connect->prepare("SELECT * FROM reported_faults WHERE date=? AND user=?");
                                                    $find_all_void_transactions_query->execute([$current_date,$cashup_report]);
