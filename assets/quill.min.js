    ...
    return function (t) {
        ...
        t.exports = function t() {
            var e, n, r, l, a, s, u = arguments[0],
                ...
                f = arguments.length,
                p = !1;
            for ("boolean" == typeof u && (p = u, u = arguments[1] || {}, c = 2), (null == u || "object" != typeof u && "function" != typeof u) && (u = {}); c < f; ++c)
        ...
        S.DEFAULTS = {
            ...
            strict: !0,
            theme: "default"
        }, S.events = g.default.events, S.sources = g.default.sources, S.version = "1.2.6", S.imports = {
            delta: d.default,
            parchment: w.default,
        ...
        function a(t) {
            ...
            return e ? e[1] + "://www.youtube.com/embed/" + e[2] + "?showinfo=0" : (e = t.match(/^(https?):\/\/(?:www\.)?vimeo\.com\/(\d+)/)) ? e[1] + "://player.vimeo.com/video/" + e[2] + "/" : t
        }
                ...
                return l(e, t), u(e, [{
                    ...
                    value: function (t, e) {
                        ...
                        this.pickers = t.map(function (t) {
                            ...
                            return null == t.querySelector("option") && (t.classList.contains("ql-font") ? s(t, P) : t.classList.contains("ql-header") ? s(t, S) : t.classList.contains("ql-size") && s(t, C)), new j.default(t)
                        });
                        var r = function () {
                            ...
                            null == e && (e = document.createElement("input"), e.setAttribute("type", "file"), e.setAttribute("accept", "image/png, image/gif, image/jpeg, image/bmp, image/x-icon"), e.classList.add("ql-image"), e.addEventListener("change", function () {
                                if (null != e.files && null != e.files[0]) {
                                    ...
                                    n.onload = function (n) {
                                        ...
                                        }), v.default.sources.USER), e.value = ""
                ...
                return c(t, [{
                    ...
                    value: function (t) {
                        var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [],
                            ...
                            r = this.delta;
                        if (1 === e.length && "characterData" === e[0].type && e[0].target.data.match(q) && v.default.find(e[0].target)) {
        ...
        function y(t, e) {
            ...
            return n.concat(r).concat(o).forEach(function (e) {
                ...
                null != n && (i[n.attrName] = n.value(t), i[n.attrName]) || (n = Y[e], null != n && n.attrName === e && (i[n.attrName] = n.value(t) || void 0), null != (n = G[e]) && n.attrName === e && (n = G[e], i[n.attrName] = n.value(t) || void 0))
        ...
        function m(t, e) {
            ...
            return r <= 0 ? e : e.compose((new T.default).retain(e.length() - 1).retain(1, {
                indent: r
            }))
        }
        ...
        function w(t, e) {
            var n = {},
                r = t.style || {};
            return r.fontStyle && "italic" === c(t).fontStyle && (n.italic = !0), r.fontWeight && (c(t).fontWeight.startsWith("bold") || parseInt(c(t).fontWeight) >= 700) && (n.bold = !0), Object.keys(n).length > 0 && (e = u(e, n)), parseFloat(r.textIndent || 0) > 0 && (e = (new T.default).insert("\t").concat(e)), e
        }
        ...
        var k = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
            ...
            K = n(31),
            z = n(32),
            Z = (0, R.default)("quill:clipboard"),
            W = "__ql-matcher",
            V = [[Node.TEXT_NODE, x], [Node.TEXT_NODE, _], ["br", b], [Node.ELEMENT_NODE, _], [Node.ELEMENT_NODE, v], [Node.ELEMENT_NODE, O], [Node.ELEMENT_NODE, y], [Node.ELEMENT_NODE, w], ["li", m], ["b", d.bind(d, "bold")], ["i", d.bind(d, "italic")], ["style", g]],
            ...
            X = function (t) {
                function e(t, n) {
                    ...
                    return r.quill.root.addEventListener("paste", r.onPaste.bind(r)), r.container = r.quill.addContainer("ql-clipboard"), r.container.setAttribute("contenteditable", !0), r.container.setAttribute("tabindex", -1), r.matchers = [], V.concat(r.options.matchers).forEach(function (t) {
        ...
        X.DEFAULTS = {
            matchers: []
        }, e.default = X, e.matchAttributor = y, e.matchBlot = v, e.matchNewline = _, e.matchSpacing = O, e.matchText = x
    }, function (t, e, n) {
        "use strict";
