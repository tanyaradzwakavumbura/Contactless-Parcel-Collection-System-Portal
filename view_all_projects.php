                    ...
                    <div>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-style1 mg-b-10">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">View All Active Projects</li>
                            </ol>
                        </nav>
                        <h4 class="mg-b-0 tx-spacing--1">View All Active Projects</h4>
                    </div>
                    <div class="d-none d-md-block">
                        
                        <a href="record_new_project.php" class="btn btn-sm pd-x-15 btn-primary btn-uppercase"><i data-feather="user" class="wd-10 mg-r-5"></i>Record New Project</a>
                    ...
                    <div data-label="Example" class="df-example demo-table col-md-12">
                        ...
                        <table id="example1" class="table table-hover table-bordered">
                            ...
                            <tbody>
                                ...
                                $find_data = $connect->prepare("SELECT * FROM projects WHERE status=?");
                                $stat = "";
                                $find_data->execute([$stat]);
                                while($row=$find_data->fetch(PDO::FETCH_ASSOC)){
                                    ...
                                    $project_target = $row["amount"];

                                    //$find_all_members = $connect->prepare("SELECT * FROM members WHERE cell_group=?");
                                    //$find_all_members->execute([$cell_code]);
                                    //$count_all_cell_members = $find_all_members->rowCount();
                               ...
                               ?>
                                <tr>
                                    ...
                                    <td><?php echo format_money($project_target);?></td>
                                    <td><?php echo 5;?></td>
                                    <td><span class="badge badge-warning">Pending : 0%</span></td>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    ...
                                                    <form method="post">
                                                        ...
                                                        <button type="submit" name="delete_prepayment" class="dropdown-item">Update Project Details</button>

                                                        <button type="submit" name="delete_prepayment" class="dropdown-item">Open Project</button>
                                                        
                                                        <button type="submit" name="delete_prepayment" class="dropdown-item">Record Pledge</button>

                                                        <button type="submit" name="delete_prepayment" class="dropdown-item">Deactivate Project</button>
                                                    </form>
