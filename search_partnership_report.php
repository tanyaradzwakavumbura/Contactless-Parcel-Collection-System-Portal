                    ...
                    <div>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-style1 mg-b-10">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Search Partnership Report</li>
                            </ol>
                        </nav>
                        <h4 class="mg-b-0 tx-spacing--1">Search Partnerhsip Report</h4>
                    </div>
                    
                    <div class="d-none d-md-block">
                        <a href="#" class="btn btn-sm pd-x-15 btn-white btn-uppercase"><i data-feather="user" class="wd-10 mg-r-5"></i>Full Members Report</a>
                        <a href="#" class="btn btn-sm pd-x-15 btn-primary btn-uppercase mg-l-5"><i data-feather="user" class="wd-10 mg-r-5"></i> First Timers Report</a>
                    </div>
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="row">
                                <div class="form-group col-12">
                                    <label class="d-block">Choose Partnership</label>
                                    <select name="partnership" id="partnership" class="form-control" style="border-color:#767F9B; border-width:1px; border-radius:10px" required>
                                        <option value="">Select Partnership</option>
                                       <?php
                                       $find_all_projects = $connect->prepare("SELECT * FROM projects");
                                       $find_all_projects->execute();
                                       while($row=$find_all_projects->fetch()){
                                ...
                                <div class="form-group col-12">
                                    <label class="d-block">Choose Year</label>
                                    <select name="partnership_year" id="partnership_year" class="form-control" style="border-color:#767F9B; border-width:1px; border-radius:10px" required>
                            ...
                            <br>
                            <center>
                                <button type="submit" class="btn btn-primary" name="generate_partnership_report">Generate Partnership Report</button>
                            </center>
