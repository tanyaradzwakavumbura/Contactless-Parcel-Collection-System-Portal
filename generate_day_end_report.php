                        ...
                        <form action="" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-12">
                                    <label class="d-block">Choose Cashier</label>
                                    <select class="form-control" style="border-color:#767F9B; border-width:1px; border-radius:10px" name="cashier_reporter" required>
                                        <option value="">Choose Cashier</option>
                                        <?php
                                        $find_other_cashiers = $connect->prepare("SELECT DISTINCT(cashier) FROM vehicle_entry WHERE date=?");
                                        $find_other_cashiers->execute([$current_date]);
                                        while($row=$find_other_cashiers->fetch(PDO::FETCH_ASSOC)){
                                            $cashier = $row["cashier"];

                                            ?>
                                            <option><?php echo $cashier;?></option>
                                            <?php
                                        }
                                        ?>
                                    </select>
                            ...
                            <center>
                                ...
                                <button type="submit" class="btn btn-primary" name="generate_cashup_report_for_cashier">Generate Daily Report</button>
                            </center>
