                    ...
                    <div>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-style1 mg-b-10">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Generate Day End Report for Other Days</li>
                            </ol>
                        </nav>
                        <h4 class="mg-b-0 tx-spacing--1">Generate Day End Report for Other Days</h4>
                    </div>
                    
                    <div class="d-none d-md-block">
                        <a href="generate_day_end_report.php" class="btn btn-sm pd-x-15 btn-white btn-uppercase"><i data-feather="user" class="wd-10 mg-r-5"></i>Generate Day End Report</a>
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <select class="form-control" style="border-color:#767F9B; border-width:1px; border-radius:10px" name="report_date" required>
                                        <option value="">Choose Date</option>
                                        <?php
                                        $find_all_dates = $connect->prepare("SELECT DISTINCT(date) FROM vehicle_entry");
                                        $find_all_dates->execute();
                                        while($row=$find_all_dates->fetch(PDO::FETCH_ASSOC)){
                                            $date = $row["date"];
                                            ?>
                            ...
                            <center>
                                ...
                                <button type="submit" class="btn btn-primary" name="generate_cashup_report_for_the_otherday">Generate Daily Report</button>
                            </center>
