                            ...
                            <tbody>
                               ...
                               ?>
                                <tr>
                                    ...
                                    <td>
                                        <form method="post">
                                            <input type="text" hidden name="the_id" value="<?php echo $par_id;?>">
                                            <input type="text" hidden name="the_code" value="<?php echo $par_code;?>">
                                           
                                            <button type="submit" name="parcel_was_delivered_successfully" class="btn btn-primary btn-sm">Delivered</button>
                                        </form>
                                    </td>
