...
<body>
                    ...
                    <div class="row row-xs">
                        <div class="container mt-4">
                            <header class="text-center mb-4">
                                <h2 class="display-6">Service Attendance Report for <?php echo format_date($service_date);?></h2>
    ...
    function generateReport() {
        ...
        const opt = {
            ...
            filename: "<?php echo $service_date; ?> Full Service Attendance Report.pdf",
            image: {
                type: 'jpeg',
                quality: 0.5
