...
<body>
                    ...
                    <div>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-style1 mg-b-10">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">New Convert Report</li>
                            </ol>
                        </nav>
                        <h4 class="mg-b-0 tx-spacing--1">New Convert Report</h4>
                    ...
                    <div class="row row-xs">
                        <div class="container mt-4">
                            <header class="text-center mb-4">
                                <h2 class="display-6">New Convert Report</h2>
    ...
    function generateReport() {
        ...
        const opt = {
            ...
            filename: " New Converts Report.pdf",
            image: {
                type: 'jpeg',
                quality: 0.5
