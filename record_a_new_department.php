            ...
            <div class="container pd-x-0">
                <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
                    <div>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-style1 mg-b-10">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Record New Department</li>
                            </ol>
                        </nav>
                        <h4 class="mg-b-0 tx-spacing--1">Record New Department</h4>
                    </div>
                    <div class="d-none d-md-block">
                        ...
                        <a href="record_new_cell.php" class="btn btn-sm pd-x-15 btn-primary btn-uppercase mg-l-5"><i data-feather="book" class="wd-10 mg-r-5"></i> Record New Cell</a>
                    </div>
                </div>
                                ...
                                <div class="row align-items-sm-end">
                                    <div class="col-lg-7 col-xl-8">
                                        ...
                                        <form action="" method="POST" enctype="multipart/form-data">
                                            ...
                                            <input type="text" name="department_code" value="<?php echo calculateDepartmentCode($connect);?>" hidden>
                                          
                                            <div class="form-group">
                                                <label class="d-block">Department Name</label>
                                                <input type="text" style="border-color:#7CB74B; border-width:1px; border-radius:10px" class="form-control" id="department_name" name="department_name" placeholder="Enter Department Name" required>
                                            </div>

                                            
                                          
                                            <button type="submit" onclick="record_new_department_show_loader()" class="btn btn-primary" name="record_new_department">Record New Department</button>
