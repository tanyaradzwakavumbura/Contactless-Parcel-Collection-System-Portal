...
<body>
            ...
            <div class="container pd-x-0">
                <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
                    <div>
                        ...
                        <h4 class="mg-b-0 tx-spacing--1">Service Report for <?php echo format_date($service_date);?>
                        </h4>
                    </div>
                    ...
                    <div class="row row-xs">
                        <div class="container mt-4">
                            <header class="text-center mb-4">
                                <h1 class="display-4">Service Report for <?php echo format_date($service_date);?></h1>
                                <p class="lead">Total Attendance : <?php echo $count_total_attendance;?></p>
                            ...
                            <div class="col-lg-12 col-xl-12">
                                ...
                                <div class="card" id="card1"
                                    ...
                                    <div
                                        class="card-header bd-b-0 pd-t-20 pd-lg-t-25 pd-l-20 pd-lg-l-25 d-flex justify-content-between align-items-center">
                                        <div>
                                            <h6 class="mg-b-5">Attendance</h6>
                                            <p class="tx-12 tx-color-03 mg-b-0">Total Attendance for the Service :
                                                <?php echo $count_total_attendance;?></p>
                                        </div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-striped mg-b-0 table-bordered table-hover">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        $s = "";
                                                        $find_attendance_query = $connect->prepare("SELECT DISTINCT(member) FROM member_attendance WHERE date=? AND member !=?");
                                                        $find_attendance_query->execute([$service_date,$s]);
                                                        while($row=$find_attendance_query->fetch(PDO::FETCH_ASSOC)){
                                                            $member_code = $row["member"];
                                                            $find_member_details_query = $connect->prepare("SELECT * FROM members WHERE code=?");
                                                            $find_member_details_query->execute([$member_code]);
                                                            while($row=$find_member_details_query->fetch(PDO::FETCH_ASSOC)){
                                                                ...
                                                                $member_cell = $row["cell_group"];
                                                                $member_status = $row["member_status"];


                                                                if($member_cell == "No-Cell"){
                                                                   $cell_badge = "badge badge-danger";
                                                                   $cell_text = "No Cell";
                                                                }else{
                                                                    $find_member_cell = $connect->prepare("SELECT * FROM cells WHERE code=?");
                                                                    $find_member_cell->execute([$member_cell]);
                                                                    while($row=$find_member_cell->fetch(PDO::FETCH_ASSOC)){
                                                                        $cell_name = $row["name"];
                                                                    }

                                                                    $cell_badge = "badge badge-success";
                                                                    $cell_text = $cell_name;
                                                                }

                                                                if($member_status == "member"){
                                                                    $m_status_badge = "badge badge-success";
                                                                   $m_status_text = "Full Member";
                                                                }else{
                                                                    $m_status_badge = "badge badge-danger";
                                                                    $m_status_text = "First Timer";
                                                                }
                                                        ...
                                                        ?>
                                                        <tr>
                                                            <td><?php echo $member_code." ".$member_fullname;?></td>
                                                            <td><?php echo $member_phone;?></td>
                                                            <td><?php echo $member_email;?></td>
                                                            <td><span
                                                                    class="<?php echo $cell_badge;?>"><?php echo $cell_text;?></span>
                                                            </td>
                                                            <td><span
                                                                    class="<?php echo $m_status_badge;?>"><?php echo $m_status_text;?></span>
                                                            </td>
                            ...
                            <div class="col-lg-12 col-xl-12">
                                ...
                                <div class="card" id="card1"
                                    ...
                                    <div
                                        class="card-header bd-b-0 pd-t-20 pd-lg-t-25 pd-l-20 pd-lg-l-25 d-flex justify-content-between align-items-center">
                                        <div>
                                            <h6 class="mg-b-5">Members who didnt attend Service</h6>
                                            <p class="tx-12 tx-color-03 mg-b-0">Total Attendance for the Service :
                                                <?php echo $count_total_attendance;?></p>
                                        </div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-striped mg-b-0 table-bordered table-hover">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        $s = "";
                                                        $find_attendance_query = $connect->prepare("SELECT * FROM members WHERE code NOT IN (SELECT member FROM member_attendance WHERE date=?)");
                                                        $find_attendance_query->execute([$service_date]);
                                                        while($row=$find_attendance_query->fetch(PDO::FETCH_ASSOC)){
                                                                $member_fullname = $row["fullname"];
                                                                $member_phone = $row["phone_number"];
                                                                $member_email = $row["email"];
                            ...
                            <div class="col-lg-12 col-xl-12">
                                ...
                                <div class="card" id="card1" style="border-color:#031A61; border-width:1px; border-radius:10px">
                                    <div class="card-body pd-lg-25 text-center">
                                        ...
                                        <p class="tx-12 tx-color-03 mg-b-0">This is the end of the service report for <?php echo format_date($service_date); ?>.</p>
                                    </div><!-- card-body -->
                                </div><!-- card -->
                            </div>
                        </div>
    ...
    function generateReport() {
        ...
        const opt = {
            ...
            filename: "<?php echo $service_date; ?> Full Service Report.pdf",
            image: {
                type: 'jpeg',
                quality: 0.5
