            ...
            <div class="container ">
                <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
                    <div>
                        ...
                        <h4 class="mg-b-0 tx-spacing--1">Monthly Report Generator</h4>
                    </div>
                    
                    <div class="d-none d-md-block">
                        <a href="daily_statistics_generator_search.php" class="btn btn-sm pd-x-15 btn-white btn-uppercase"><i data-feather="user" class="wd-10 mg-r-5"></i>Daily Statistics</a>
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <select class="form-control" style="border-color:#767F9B; border-width:1px; border-radius:10px" name="choose_year" required>
                                        <option value="">Choose Year</option>
                                        <?php
                                        $stat = "closed";
                                        $find_years = $connect->prepare("SELECT DISTINCT YEAR(date) AS the_year FROM vehicle_entry WHERE status=? ORDER BY the_year DESC");
                                        $find_years->execute([$stat]);
                                        while($row=$find_years->fetch(PDO::FETCH_ASSOC)){
                                            $the_year = $row["the_year"];
                                            ?>
                                        <option><?php echo $the_year;?></option>
                                        <?php
                                        }
                                        ?>
                                    </select>
                            ...
                            <br>
                            <center>
                                <button type="submit" class="btn btn-primary" name="generate_monthly_report">Generate Monthly Report</button>
                            </center>
