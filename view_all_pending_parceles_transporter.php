                ...
                <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
                    <div>
                            ...
                            <ol class="breadcrumb breadcrumb-style1 mg-b-10">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">View All Pending Parcels</li>
                            </ol>
                        </nav>
                        <h4 class="mg-b-0 tx-spacing--1">View All Pending Parcels</h4>
                           
                    </div>
                    <div class="d-none d-md-block">
                        <a href="view_all_in_transit_parcels_by_transporter" class="btn btn-sm pd-x-15 btn-primary btn-uppercase"><i data-feather="book" class="wd-10 mg-r-5"></i>In-Transit Parcels</a>
                        
                        <a href="view_all_delivered_parcels_transporter" class="btn btn-sm pd-x-15 btn-warning btn-uppercase"><i data-feather="book" class="wd-10 mg-r-5"></i>Delivered Parcels</a>
                    ...
                    <div data-label="Example" class="df-example demo-table col-md-12">
                        ...
                        <table id="example1" class="table table-hover table-bordered">
                            ...
                            <tbody>
                               ...
                               if($role == "transporter"){
                                    $find_all_in_transit_parcels = $connect->prepare("SELECT * FROM parcels WHERE status=?");
                                    $statp = "Pending";
                                    $find_all_in_transit_parcels->execute([$statp]);
