                                ...
                                <div class="">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <a href="#applicant<?php echo $aseet_id;?>" class="dropdown-item" data-toggle="modal">Update Asset</a>
                                            ...
                                            <form method="post">
                                                ...
                                                <input type="text" name="del_id" value="<?php echo $aseet_id;?>" hidden>
                                                
                                                <button type="submit" name="open_asset" class="dropdown-item">Open Asset Record</button>
                                                
                                                <button type="submit" name="delete_asset" class="dropdown-item">Delete Asset</button>
